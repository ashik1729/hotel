...
$this->title = 'Create Merchant Category';
$this->params['breadcrumbs'][] = ['label' => 'Merchant Categories', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>


<div class="content merchant-category-create">
    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">
                    <?=  $model->isNewRecord ? 'Create Merchant Category' : 'Update Merchant Category';?>
