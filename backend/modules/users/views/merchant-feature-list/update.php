...
$this->title = 'Update Merchant Feature List: ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Merchant Feature Lists', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>


<div class="content merchant-feature-list-create">
    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">
                    <?= $model->isNewRecord ? 'Update Merchant Feature List' : 'Update Merchant Feature List'; ?>
