...
$this->title = 'Update Packages Itinerary: ' . $model->title;
$this->params['breadcrumbs'][] = ['label' => 'Packages Itineraries', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->title, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>


<div class="content packages-itinerary-create">
    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">
                    <?=  $model->isNewRecord ? 'Update Packages Itinerary' : 'Update Packages Itinerary';?>
