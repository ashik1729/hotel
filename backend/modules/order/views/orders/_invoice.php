<html>
    <head>
        <title><?= $lang == 2 ? Yii::$app->ManageRequest->getVariable('title_ar') : Yii::$app->ManageRequest->getVariable('title_ar'); ?></title>
            ...
            foreach ($merchant_list as $merchant_id) {
                ...
                <div style="margin:auto; width:776px; border:solid 1px #c0c0c0; margin-top:40px; margin-bottom:40px;">
                    <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                        ...
                        <tr><td  width="776" style="padding-bottom: 20px"> <span style="font-size: 20px;font-weight: bold;padding-left:10px;padding-bottom: 20px;font-family: 'Open Sans',arial, sans-serif;">Invoice Number #<?php echo $orderProduct->invoice; ?></span>
                            </td>
                        </tr>
                        <br>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="776" style="    font-family: 'Open Sans',arial, sans-serif;font-size: 13px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td valign="top" style="font-size:13px;padding:9px 9px 9px 9px;border-left:1px solid #eaeaea;border-bottom:1px solid #eaeaea;border-right:1px solid #eaeaea">
                                                <p style="font-weight: bold;font-size: 15px;">Invoice Number : #<span><?php echo $orderProduct->invoice; ?></span></p>
                                                <p style="font-weight: bold;font-size: 15px;">Invoice Date : <?php echo date('Y-m-d', strtotime($orderProduct->invoice_date)); ?></p>
