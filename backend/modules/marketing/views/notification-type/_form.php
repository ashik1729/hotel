...
<div class="card-body notification-type-form">
            ...
            <div class="form-group bmd-form-group">
                <div id="imagePriview">
                    ...
                    if (isset($model->id) && $model->id > 0 && isset($model->image) && $model->image !== "") {
                        $imgPath = ((yii\helpers\Url::base())) . '/../uploads/notification-type/' . $model->image;
                    } else {
                ...
                <br/>
                <?php
                echo '<label class="control-label">Upload Language Icon</label>';
