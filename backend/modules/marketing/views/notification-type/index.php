...
/* @var $searchModel common\models\NotificationTypeSearch */
...
<div class="content notification-type-index">
...
//                                    'status',
                                    [
                                        ...
                                        'value' => function ($data) {
                                            if ($data->image != '') {
                                                return Yii::$app->request->baseUrl . '/../uploads/notification-type/' . $data->image;
                                            } else {
