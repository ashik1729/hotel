...
/* @var $searchModel common\models\AdminRoleSearch */
...
<div class="content admin-role-index">
                            ...
                            GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function($data) {
                                            if ($data->status == 1) {
                                                return "<span style='color:black;font-weight:bold'>Enable</span>";
                                            } else if ($data->status == 0) {
                                                return "<span style='color:blue;font-weight:bold'>Disabled</span>";
                                            } else {
                                                return "Disabled";
                                            }
                                        },
