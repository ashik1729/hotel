...
?>
<div class="content business-category-index">
...
//                                                $option_items = Yii::$app->SelectCategory->selectBusinessCategories($model);
//                                                $option_data = explode('-', $option_items);
//                                                $option_data_array = array_reverse($option_data);
//                                                if ($option_data_array != NULL) {
//                                                    $i = 1;
...
//                                                            } else {
//                                                                $html .= '<li class = "breadcrumb-item"><a href = "' . $caturl . '">' . $option_cat->title . '</a></li>';
//                                                            }
//                                                            $i++;
//                                                        }
//                                                    }
