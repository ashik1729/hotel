...
$this->title = 'Update Global Variables: ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Global Variables', 'url' => ['index']];
    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">
                    <?= $model->isNewRecord ? 'Update Variables' : 'Update Variables '; ?>
