...
<div class="card-body flight-request-form">
    ...
    <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group bmd-form-group">
                            <?= $form->field($model, 'from_place')->textInput(['maxlength' => true]) ?>
                ...
                <div class="col-sm-12">
                    <div class="form-group bmd-form-group">
                            <?= $form->field($model, 'no_room')->textInput() ?>
                ...
                <div class="col-sm-12">
                    <div class="form-group bmd-form-group">
                            <?= $form->field($model, 'to_place')->textInput(['maxlength' => true]) ?>
