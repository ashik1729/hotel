...
$this->title = 'Update Rental Enquiry: ' . $model->name;
$this->params['breadcrumbs'][] = ['label' => 'Rental Enquiries', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>


<div class="content rental-enquiry-create">
    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">
                    <?=  $model->isNewRecord ? 'Update Rental Enquiry' : 'Update Rental Enquiry';?>
