...
/* @var $searchModel common\models\MobileStringsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Mobile Strings';
$this->params['breadcrumbs'][] = $this->title;
?>
<?php $model_path = str_replace(" ", "-", strtolower(Html::encode($this->title))) ?>


<div class="content mobile-strings-index">
                    ...
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="<?= \yii\helpers\Url::to(['import']); ?>" class="btn btn-success">
                                    <span class="btn-label">
                                        <i class="material-icons">file_upload</i>
                                    </span>
                                    Import Localaised Strings
