                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                if ($data->image != '') {
                                    return Yii::$app->request->baseUrl . '/../uploads/cms/' . $data->id . '/image/' . $data->image;
                                } else {
                                ...
                                if ($data->gallery != '') {
                                    ...
                                    if ($images != NULL) {
                                        foreach ($images as $image) {
                                            $result_html .= "<img src='" . Yii::$app->request->baseUrl . '/../uploads/cms/' . $data->id . '/gallery/' . $image . "' />";
                                        }
                                    }
                                    return $result_html;
                                } else {
