...
/* @var $searchModel common\models\CmsContentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Cms Contents';
$this->params['breadcrumbs'][] = $this->title;
?>
<?php $model_path = str_replace(" ", "-", strtolower(Html::encode($this->title))) ?>


<div class="content cms-content-index">
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function($model) {
                                            if ($model->image != "") {
                                                return Yii::$app->request->baseUrl . '/../uploads/cms/' . $model->id . '/image/' . $model->image;
                                            } else {
