    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group bmd-form-group">
                <?= $form->field($model, 'page_id')->textInput(['maxlength' => true, 'disabled' => true]) ?>
        ...
        <div class="col-sm-12">
            <div class="form-group bmd-form-group">
                <?php // $form->field($model, 'short_description')->textarea(['rows' => 6]) 
                ?>
            </div>
        </div>
        <div class="col-sm-12">
            ...
            <div class="form-group bmd-form-group">
                <div id="imagePriview">
                    ...
                    if (isset($model->id) && $model->id > 0 && isset($model->image) && $model->image !== "") {
                        $imgPath = ((yii\helpers\Url::base())) . '/../uploads/cms/' . $model->id . '/image/' . $model->image;
                    } else {
                    ...
                    if ($images != NULL) {
                        foreach ($images as $image) {
                            if (isset($model->id) && $model->id > 0 && isset($model->gallery) && $model->gallery !== "") {
                                $imgPath = ((yii\helpers\Url::base())) . '/../uploads/cms/' . $model->id . '/gallery/' . $image;
                            } else {
                                $imgPath = Yii::$app->request->baseUrl . '/img/no-image.jpg';
                            }
