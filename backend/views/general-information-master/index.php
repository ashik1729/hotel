...
/* @var $searchModel common\models\GeneralInformationMasterSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'General Information Masters';
$this->params['breadcrumbs'][] = $this->title;
?>
<?php  $model_path = str_replace(" ", "-", strtolower(Html::encode($this->title))) ?>


<div class="content general-information-master-index">
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model) {
                    if ($model->image != "") {
                        return Yii::$app->request->baseUrl . '/../uploads/general-information/' . $model->id . '/image/' . $model->image;
                    } else {
