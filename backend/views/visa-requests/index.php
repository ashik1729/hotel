...
/* @var $searchModel common\models\VisaRequestsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Visa Requests';
$this->params['breadcrumbs'][] = $this->title;
?>
<?php $model_path = str_replace(" ", "-", strtolower(Html::encode($this->title))) ?>


<div class="content visa-requests-index">
                            ...
                            <?= GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'visa_id',
                                        'label' => 'Visa Country',
                                        'filter' => ArrayHelper::map(\common\models\Visa::find()->where(['status' => 1])->all(), 'id', 'title'),
                                    ...
                                    [
                                        ...
                                        'label' => 'Visa Option',
                                        'filter' => ArrayHelper::map(\common\models\VisaOption::find()->where(['status' => 1])->all(), 'id', 'title'),
                                        'value' => function ($model) {
                                    ...
                                    [
                                        'attribute' => 'user_id',
                                        'label' => 'User Email',
                                        'filter' => ArrayHelper::map(\common\models\User::find()->where(['status' => 1])->all(), 'id', 'email'),
                                        'value' => function ($model) {
                                    ...
                                    [
                                        ...
                                        'filter' => ArrayHelper::map(\common\models\ProcessingType::find()->where(['status' => 1])->all(), 'id', 'title'),
                                        'value' => function ($model) {
