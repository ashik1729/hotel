...
/* @var $searchModel common\models\AccomodationSearch */
...
<div class="content accomodation-index">
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            if ($model->image != "") {
                                                return Yii::$app->request->baseUrl . '/../uploads/accomodation/' . $model->id . '/image/' . $model->image;
                                            } else {
