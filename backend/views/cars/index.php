    ...
    <div class="container-fluid">
        ...
        'columns' => [
            ...
            [
                'attribute' => 'brand',
                'label' => 'Brands',
                'filter' => ArrayHelper::map(\common\models\Brands::find()->where(['status' => 1])->all(), 'id', 'title'),
            ...
            [
                ...
                'value' => function($model) {
                    if ($model->image != "") {
                        return Yii::$app->request->baseUrl . '/../uploads/cars/' . $model->id . '/image/' . $model->image;
                    } else {
