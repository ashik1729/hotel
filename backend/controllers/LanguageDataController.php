...
use Yii;
use common\models\LanguageData;
use common\models\LanguageDataSearch;
...
/**
 * LanguageDataController implements the CRUD actions for LanguageData model.
 */
class LanguageDataController extends Controller {
    ...
    /**
     * Displays a single LanguageData model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new LanguageData model.
    ...
    /**
     * Updates an existing LanguageData model.
    ...
    /**
     * Deletes an existing LanguageData model.
